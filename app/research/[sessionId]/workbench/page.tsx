...
export default async function WorkbenchPage({ params, searchParams }: { params: Promise<{ sessionId: string }>; searchParams: Promise<{ view?: string; resourceId?: string }> }) {
  ...
  try {
    ...
    return <div className="space-y-4">
      ...
      <ExplorationWorkbench initialState={state} initialView={(["reading", "concept", "evidence"].includes(query.view ?? "") ? query.view : "reading") as WorkbenchView} focusedResourceId={query.resourceId} />
    </div>;
  } catch {
